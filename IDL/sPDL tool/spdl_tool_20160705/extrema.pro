...
; Modified 19-JUN-2015 by Olivier Gasnault. Change use of One_of by keyword_set
; (One_of use EXECUTE which is not compatible with Virtual Machine)
;-
...
;    both = One_of(mino,maxo) eq -1
    both = (~keyword_set(mino)) and (~keyword_set(mano))
