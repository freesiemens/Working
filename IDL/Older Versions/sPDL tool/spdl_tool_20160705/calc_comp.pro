...
;  endfor
  ...
  for k=0,n_elements(refnames)-1 do begin
    ...
    newline='!C'
    cgtext,x[1],y[1],strjoin(strsplit(refnames[k],' ',/extract),newline),alignment=alignment[0],charsize=3,charthick=5,font=1
    
  endfor
  ;write the legend
  al_legend,legendnames,psym=legendsyms,colors=legendsymcolors,symsize=4,charsize=3,charthick=5,font=1
