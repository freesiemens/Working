...
; O. Forni: May 2015
; O. Gasnault: June 27, 2015 - Add /NULL to 2 WHERE functions otherwise the
;    last value of CFT could be put to 0 if there was no negative or NaN values
;-
...
;;     for n=0,nsp-1 do *cfa(n)=*cf(n)
  ...
  if t eq 10 then begin
     ...
     for n=0,nsp-1 do begin
        ...
        cft(where(cft lt 0., /NULL))=0.
        cft(where(finite(cft) eq 0, /NULL))=0.
        *cfa(n)=cft
