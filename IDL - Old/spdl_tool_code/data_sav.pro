; Modified 27 Jun 2015 (OG): Add GOODGAIN to stop the code if GAIN=0.
...
i0=where(gain ne 0, goodgain)
if goodgain eq 0 then message,'All the values of GAIN are equal to 0.'
