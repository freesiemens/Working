...
#mid_cv_file=outpath+'\\'+which_elem+'_'+plstype+'_nc'+str(midnc)+'_norm'+str(midnorm)+'_'+str(midmin)+'-'+str(midmax)+'_cv_predict.csv'
...
outfile1to1_full=outpath+'\\'+which_elem+'_submodels_1to1_plot_'+str(xminmax[0])+'_'+str(xminmax[1])+'_full.png'
outfile1to1_low=outpath+'\\'+which_elem+'_submodels_1to1_plot_'+str(xminmax[0])+'_'+str(xminmax[1])+'_low.png'
outfile1to1_mid=outpath+'\\'+which_elem+'_submodels_1to1_plot_'+str(xminmax[0])+'_'+str(xminmax[1])+'_mid.png'
outfile1to1_high=outpath+'\\'+which_elem+'_submodels_1to1_plot_'+str(xminmax[0])+'_'+str(xminmax[1])+'_high.png'
...
imgfile_full=outpath+'\\'+which_elem+'_final_model_predictions_1to1_'+str(xminmax[0])+'-'+str(xminmax[1])+'_full.png'
imgfile_low=outpath+'\\'+which_elem+'_final_model_predictions_1to1_'+str(xminmax[0])+'-'+str(xminmax[1])+'_low.png'
imgfile_high=outpath+'\\'+which_elem+'_final_model_predictions_1to1_'+str(xminmax[0])+'-'+str(xminmax[1])+'_high.png'
...
"""
If low model 0 to 2, use the low model
if low model is 2 to 4, blend the low and full model using low as reference
if full mode is 4 to 10 use full
If full model is >10 and <15, blend full and high using full  as reference
if full and high >15, use high
...
ranges=[[0,2],[2,4],[4,10],[10,15],[15,100]]
inrange=[1,1,0,0,[0,2]]
refpredict=[1,1,0,0,0]
toblend=[[1,1],[0,1],[0,0],[0,2],[2,2]]
