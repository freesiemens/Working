...
coeff_file_low=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc20_norm3_0-3.5_beta_coeffs.csv'
means_file_low=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc20_norm3_0-3.5_meancenters.csv'
...
coeff_file_high=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc20_norm3_2.5-100_beta_coeffs.csv'
means_file_high=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc20_norm3_2.5-100_meancenters.csv'
...
for i in range(len(y_combined)):
   ...
   #     y_combined[i]=y_mid[i]
    if y_full[i]>low_cutoff:#high_cutoff:
        y_combined[i]=y_high[i]
        
with open(outpath+'\\'+which_elem+'_predictions_caltargets.csv','wb') as writefile:
