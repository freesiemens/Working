...
if low model is 2 to 2.5, blend the low and high model using low as reference
if full model is >2.5 use high
...
ranges=[[0,2],[2,2.5],[2.5,100],[0,100]]
inrange=[1,1,0,0]
refpredict=[1,1,0,0]
toblend=[[1,1],[1,2],[2,2],[0,0]]
