...
coeff_file_low=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\CaO_mlpy_nc20_norm3_0-15_beta_coeffs.csv'
means_file_low=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\CaO_mlpy_nc20_norm3_0-15_meancenters.csv'
...
with open(outpath+'\\'+which_elem+'_predictions.csv','wb') as writefile:
        ...
        row=['','','Full (0-100)','Low (0-15)','High (10-100)','Combined']
        writer.writerow(row)
