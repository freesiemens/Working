...
med_cv_file=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc20_norm3_2-12_cv_predict.csv'
high_cv_file=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc20_norm3_10-100_cv_predict.csv'
import numpy
import csv
import ccam_plots
nc=6
...
labels=['Full (nc=6, norm=3, RMSECV='+str(RMSECV_full)+')','Low (nc=10,norm=3, RMSECV='+str(RMSECV_low)+')','Med (nc=3,norm=3, RMSECV='+str(RMSECV_med)+')','High (nc=5,norm=3, RMSECV='+str(RMSECV_high)+')']
colors=['c','r','g','b']
markers=['o','v','s','^']
plot_title='MgO Cross Validation (combined RMSECV = '+str(RMSECV_combined)+')'
outfile=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_submodels_1to1_plot_0-15.png'
ccam_plots.ccam_plot_1to1(truecomps,predicts,plot_title,labels,colors,markers,outfile,comprange=[0,15])
outfile=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_submodels_1to1_plot_0-65.png'
ccam_plots.ccam_plot_1to1(truecomps,predicts,plot_title,labels,colors,markers,outfile,comprange=[0,65])
