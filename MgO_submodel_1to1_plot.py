...
full_cv_file=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc6_norm3_0-100_cv_predict.csv'
low_cv_file=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc6_norm3_0-3_cv_predict.csv'
mid_cv_file=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc6_norm3_2-12_cv_predict.csv'
high_cv_file=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_mlpy_nc6_norm3_10-100_cv_predict.csv'
...
outfile2=r'C:\Users\rbanderson\Documents\MSL\ChemCam\Data Processing\Working\Output\MgO_submodels_1to1_plot_0-15.png'
...
colors=['c','r','g','b']
markers=['o','v','s','^']
plot_title='MgO Cross Validation (combined RMSECV = '+str(RMSECV_combined)+')'
ccam.plots.Plot1to1(truecomps,predicts,plot_title,labels,colors,markers,outfile1,xminmax=comprange1,yminmax=comprange1)
ccam.plots.Plot1to1(truecomps,predicts,plot_title,labels,colors,markers,outfile2,xminmax=comprange2,yminmax=comprange2)
